...
; DAC Data
Electoria_DAC:
	dc.b	dSnare, $06, nRst, dSnare, dSnare, nRst, dSnare, dSnare, dKick, dSnare, dHighTom, dMidTom
	dc.b	dSnare, dSnare, dMidTom, dLowTom, dSnare
...
Electoria_Loop02:
	...
	smpsCall            Electoria_Call00
	dc.b	dSnare, $04, dSnare, dSnare, dSnare, $06, dSnare, dSnare, dSnare, dSnare, dSnare, nRst
	dc.b	$30
...
Electoria_Loop04:
	...
	smpsCall            Electoria_Call01
	smpsCall            Electoria_Call00
	dc.b	dKick, $06, dSnare, $12, dSnare, dKick, $06, nRst, $30
	smpsCall            Electoria_Call00
	smpsCall            Electoria_Call01
	smpsCall            Electoria_Call00
	smpsCall            Electoria_Call02
...
Electoria_Call00:
	dc.b	dKick, $0C, dKick, dSnare, nRst, $06, dSnare, nRst, dSnare, dKick, nRst, dSnare
	dc.b	$18
	smpsReturn

Electoria_Call01:
	dc.b	dKick, $06, dSnare, $12, dSnare, dKick, $06, nRst, dSnare, dKick, nRst, dSnare
	dc.b	$18
	smpsReturn

Electoria_Call02:
	dc.b	dMidTom, $0C, $0C, $0C, $06, $06, nRst, dMidTom, dMidTom, $0C, dMidTom, dMidTom
	smpsReturn

Electoria_Call03:
	dc.b	nRst, $06, dSnare, $12, dSnare, $18, nRst, $06, dSnare, $12, dSnare, $18
	smpsReturn
